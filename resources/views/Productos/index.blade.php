        ...
        <thead>
            <tr>
                ...
                <th class="text-center">
                    <a href="/productos/create" class="btn btn-primary btn-sm" id="nuevo"  
        ...
        <tbody>
            ...
            @foreach($productoss as $productos)
                <tr>
                    ...
                    <td>{{$productos->descripcion_marca}}</td>
                    <td class="text-center">
                        <form method="POST" action="/productos/{{$productos->id_producto}}" accept-charset="UTF-8" 
                            style="display:inline">
                            @csrf
                            <input name="_method" type="hidden" value="DELETE">					
                            <button type="submit" class="btn btn-danger btn-sm fa fa-trash" style="margin-right: 10px">	</button>				
                        </form>
                        <a href="/productos/{{$productos->id_producto}}/edit"><i class="btn btn-info btn-sm fa fa-edit"></i></a>
                    </td>
                </tr>
            @endforeach
        </tbody>
